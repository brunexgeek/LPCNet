...
#define RNN_COPY(dst, src, n) (memcpy((dst), (src), (size_t)(n)*sizeof(*(dst)) + (size_t)(0*((dst)-(src))) ))
#endif

/** Copy n elements from src to dst, allowing overlapping regions. The 0* term
    provides compile-time type checking */
#ifndef OVERRIDE_RNN_MOVE
#define RNN_MOVE(dst, src, n) (memmove((dst), (src), (size_t)(n)*sizeof(*(dst)) + (size_t)(0*((dst)-(src))) ))
#endif
